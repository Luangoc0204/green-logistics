    ...
    <div className="min-h-screen bg-[#FDFDFD] flex flex-col font-sans">
      ...
      <header className="h-20 flex items-center justify-between px-6 sm:px-12 lg:px-20 bg-white border-b border-gray-50">
        ...
        <nav className="hidden md:flex items-center gap-10">
          <Link
            href="#"
            className="text-sm font-black text-gray-500 hover:text-emerald-600 transition-colors"
          >
            Về chúng tôi
          </Link>
          <Link
          ...
          <div className="hidden lg:flex flex-col space-y-12">
              ...
              <div className="relative h-[480px] w-[580px] rounded-[3.5rem] bg-emerald-50/50 border border-emerald-100 overflow-hidden shadow-2xl shadow-emerald-900/5">
                ...
                <div className="absolute bottom-0 left-0 w-full p-12 bg-gradient-to-t from-gray-900/60 to-transparent text-white">
                  <h2 className="text-3xl font-black mb-2 leading-tight">
                    Giao hàng không khí thải
                  </h2>
                  <p className="text-white/80 font-bold max-w-sm">
                    Cùng kiến tạo tương lai xanh cho logistics đô thị.
                  </p>
                </div>
            ...
            <div className="grid grid-cols-2 gap-8 max-w-[580px]">
              <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                ...
                <h3 className="font-black text-gray-900 mb-2 leading-none">
                  Vận chuyển xanh
                </h3>
                <p className="text-xs font-bold text-gray-400 leading-relaxed">
                  Kết nối với mạng lưới xe điện rộng khắp.
                </p>
              </div>
              <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-12 h-12 bg-emerald-50 rounded-2xl flex items-center justify-center text-emerald-600 mb-6">
                ...
                <p className="text-xs font-bold text-gray-400 leading-relaxed">
                  Theo dõi lượng CO2 được cắt giảm mỗi đơn hàng.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white w-full max-w-[560px] rounded-[3rem] shadow-2xl shadow-gray-200/50 border border-gray-100 overflow-hidden">
              ...
              <div className="flex bg-gray-50/50 p-2 border-b border-gray-50">
                <button
                  ...
                  className={`flex-1 py-5 text-sm font-black rounded-2xl transition-all ${
                    activeTab === "login"
              ...
              <div className="p-10 sm:p-14">
                ...
                <div className="mb-10">
                  ...
                  <p className="text-emerald-600/70 font-bold">
                    {activeTab === "login"
                      ...
                      : "Tham gia cùng chúng tôi để bắt đầu hành trình xanh."}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-10">
                  <button
                    ...
                    className={`flex items-center justify-center gap-3 h-14 rounded-2xl border-2 transition-all ${
                      role === "user"
                ...
                <div className="space-y-6">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          ...
                          <Input
                            ...
                            className="h-14 pl-14 rounded-2xl border-gray-100 bg-gray-50/50 focus:bg-white text-sm font-bold transition-all"
                          />
                        </div>
                      </div>
                      <div className="space-y-2">
                        ...
                        <div className="relative group">
                          <span className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-300 font-bold group-focus-within:text-emerald-500 transition-colors">
                            +84
                          </span>
                          <Input
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between pl-1">
                      ...
                      {activeTab === "login" && (
                        <button className="text-[10px] font-black text-emerald-600 hover:text-emerald-700 uppercase tracking-wider">
                          Quên mật khẩu?
                        </button>
                      )}
                    </div>
                ...
                <p className="text-[10px] text-center text-gray-400 font-bold leading-relaxed px-4">
                  Bằng việc {activeTab === "login" ? "đăng nhập" : "đăng ký"},
                  bạn đồng ý với{" "}
