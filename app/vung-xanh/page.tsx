    ...
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mb-10 px-2">
          <h1 className="text-[42px] font-black text-gray-900 tracking-tight mb-3">
            Vùng xanh & Quy định
          </h1>
          <p className="text-lg text-emerald-600 font-medium opacity-80">
            Tra cứu khu vực hoạt động giao nhận xanh và các quy định về phương
            tiện trong nội đô.
          </p>
        </div>
        ...
        <div className="bg-white rounded-[2.5rem] p-8 md:p-10 border border-gray-100 shadow-xl shadow-gray-200/40 flex flex-col md:flex-row items-end gap-6 mb-10">
          <div className="flex-1 space-y-3 w-full">
            <label className="text-[11px] font-black text-gray-900 uppercase tracking-widest pl-1">
              Tra cứu địa chỉ
            </label>
          ...
          <div className="w-full md:w-80 space-y-3">
            ...
            <Select defaultValue="hanoi">
              ...
              <SelectContent className="rounded-2xl border-gray-100 shadow-xl">
                <SelectItem value="hanoi" className="font-bold py-3">
                  Hà Nội
                </SelectItem>
                <SelectItem value="hcm" className="font-bold py-3">
                  TP. Hồ Chí Minh
                </SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-12 flex-1">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <h4 className="text-lg font-black text-gray-900 leading-none">
                        Xe điện & Xe đạp hàng hóa
                      </h4>
                    </div>
                    <div className="flex items-center gap-2 mb-4">
                      <span className="bg-emerald-100 text-emerald-600 text-[10px] font-black px-3 py-1 rounded-md uppercase">
                        Được phép
                      </span>
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      <span className="bg-orange-100 text-orange-600 text-[10px] font-black px-3 py-1 rounded-md uppercase">
                        Hạn chế
                      </span>
                      <span className="text-[10px] font-bold text-gray-400 ml-1">
                        Cấm 06:00 - 22:00
            ...
            <div className="bg-emerald-950 rounded-[3.5rem] p-12 text-white relative overflow-hidden group border border-emerald-900 shadow-2xl">
              ...
              <p className="text-[15px] font-bold text-emerald-100/70 leading-relaxed mb-10">
                Vùng đệm là khu vực trung chuyển quan trọng (Transloading Hubs),
                nơi hàng hóa từ xe tải hạng nặng được chuyển sang các phương
                tiện không phát thải (xe điện, xe đạp) để đi vào vùng xanh, giúp
                giảm{" "}
                <span className="text-emerald-400 font-black text-lg">40%</span>{" "}
                lượng khí thải nội đô.
              </p>

              <Link
                href="#"
                className="inline-flex items-center gap-2 text-sm font-black text-white hover:text-emerald-300 transition-all group/link"
              >
      ...
      <footer className="mt-auto bg-white border-t border-gray-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
          <p className="text-sm font-bold text-gray-400">
            © 2024 GreenLogistics. All rights reserved.
          </p>
          <div className="flex items-center gap-10">
            <Link
              href="#"
              className="text-sm font-black text-gray-400 hover:text-emerald-600 transition-colors"
            >
              Quyền riêng tư
            </Link>
            <Link
