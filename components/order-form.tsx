      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Nhập chi tiết đơn hàng vận chuyển xe điện
          </p>
        </div>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-900 mb-2">
            Điểm giao hàng (Vùng xanh)
          </label>
          <div className="relative">
            <div className="absolute left-3 top-1/2 transform -translate-y-1/2 text-emerald-500 w-5 h-5">
              📍
            </div>
            <input
              type="text"
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-4 flex gap-3">
            ...
            <div>
              <p className="font-semibold text-gray-900">
                Đơn hàng đủ điều kiện vào vùng xanh
              </p>
              <p className="text-sm text-gray-600">
                Phương tiện EV được phép hoạt động 24/7
              </p>
            </div>
          </div>
        )}
        ...
        {/* Book Button */}
        <Button
          onClick={() => router.push("/chon-nha-van-chuyen")}
          className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-black py-4 rounded-2xl text-lg h-auto shadow-xl shadow-emerald-600/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
        >
          Đặt đơn ngay
        </Button>
      </div>
